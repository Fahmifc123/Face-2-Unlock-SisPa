# -*- coding: utf-8 -*-
"""
Created on Wed Jun 10 11:02:37 2020
...
class mainScreen:
    def __init__(self, top=None):
        ...
        top.focus_force()
        top.title("FACE 2 UNLOCK - PINTU OTOMATIS")
        ...
        self.Title.configure(text='''FACE 2 UNLOCK - PINTU OTOMATIS''')
        self.Title.configure(width=1374)

        self.Notification = tk.Label(top)
        self.Notification.configure(text="PINTU OTOMATIS BERBASIS FACE RECOGNITION")
        self.Notification.configure(background="#DC143C")
        self.Notification.configure(foreground="#FFFFFF")
        ...
        self.img = ImageTk.PhotoImage(Image.open("icon_pintu_otomatis.png"))   
        self.mainScreen.create_image(20,20, anchor=NW, image=self.img)    
